...
export const drugTreeData: DrugClass[] = [
  ...
  {
    name: "Miscellaneous Drugs & Therapeutic Agents",
    pharmaFocus: "Formulation of supplements, handling of sterile agents, safety and storage of special products.",
    subclasses: [
      {
        name: "Vitamins & Minerals",
        pharmaFocus: "Supplied as supplements, part of multivitamin syrups, injections, fortified foods.",
        drugs: [
            { name: "Vitamin A (Retinol)", classification: "Fat-soluble vitamin", moa: "Essential for vision, growth, cell division, reproduction and immunity.", therapeuticUses: "Treatment and prevention of Vitamin A deficiency, supportive care in measles.", adrs: "Hypervitaminosis A (toxicity) with chronic large doses.", contraindications: "Pregnancy (high doses are teratogenic).", pharmaApplications: { dosageForms: "Capsules, tablets, injection.", formulations: "Aquasol A.", storage: "Protect from light." }, analyticalMethods: { qualitative: "Spectrophotometry.", quantitative: "HPLC.", pharmacopoeial: "USP." }, specialNotes: "Risk of toxicity if overdosed since it is stored in fat." },
            { name: "Vitamin D (Calcitriol/Cholecalciferol)", classification: "Fat-soluble vitamin", moa: "Promotes calcium absorption in the gut and maintains adequate serum calcium and phosphate concentrations to enable normal bone mineralization.", therapeuticUses: "Rickets, osteomalacia, osteoporosis prevention.", adrs: "Hypercalcemia with overdose.", contraindications: "Hypercalcemia, sarcoidosis.", pharmaApplications: { dosageForms: "Tablets, capsules, oral drops.", formulations: "Caltrate, Rocaltrol.", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "LC-MS/MS.", quantitative: "HPLC, LC-MS/MS.", pharmacopoeial: "USP." }, specialNotes: "Sunlight exposure is a major source of Vitamin D." },
            { name: "Vitamin C (Ascorbic Acid)", classification: "Water-soluble vitamin", moa: "Antioxidant, required for the biosynthesis of collagen, L-carnitine, and certain neurotransmitters.", therapeuticUses: "Scurvy, dietary supplement.", adrs: "High doses can cause diarrhea and nausea.", contraindications: "N/A.", pharmaApplications: { dosageForms: "Tablets (chewable, effervescent), capsules, injection.", formulations: "Cecon.", storage: "Protect from light and air." }, analyticalMethods: { qualitative: "Titration with DCPIP.", quantitative: "HPLC, Titration.", pharmacopoeial: "USP, BP." }, specialNotes: "Excess is excreted in urine, making it relatively safe." },
            { name: "Iron (Ferrous Sulfate)", classification: "Mineral", moa: "Essential component of hemoglobin, myoglobin, and many enzymes.", therapeuticUses: "Iron-deficiency anemia.", adrs: "Constipation, dark stools, GI upset.", contraindications: "Hemochromatosis, hemosiderosis.", pharmaApplications: { dosageForms: "Tablets, oral solution.", formulations: "Feosol.", storage: "Keep away from children; overdose is toxic." }, analyticalMethods: { qualitative: "Colorimetric tests.", quantitative: "Atomic Absorption Spectroscopy.", pharmacopoeial: "USP, BP." }, specialNotes: "Best absorbed on an empty stomach, but often taken with food to reduce GI upset. Vitamin C enhances absorption." },
        ]
      },
      {
        name: "Chelating Agents",
        pharmaFocus: "Used to bind heavy metals for excretion. Also used in formulations to stabilize solutions by binding trace metals that cause oxidation.",
        drugs: [
          { name: "EDTA", classification: "Chelating Agent", moa: "Binds strongly to divalent and trivalent metal ions like lead (Pb²⁺), forming a stable, water-soluble complex that is excreted by the kidneys.", therapeuticUses: "Lead poisoning.", adrs: "Nephrotoxicity, hypocalcemia.", contraindications: "Anuria, severe renal disease.", pharmaApplications: { dosageForms: "Injection (IV).", formulations: "Calcium Disodium Versenate.", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "Complexometric titration.", quantitative: "Complexometric titration.", pharmacopoeial: "USP." }, specialNotes: "" },
          { name: "Deferoxamine", classification: "Iron Chelator", moa: "High affinity for ferric iron, forming ferrioxamine, a water-soluble complex excreted by the kidneys.", therapeuticUses: "Acute iron poisoning, chronic iron overload (hemosiderosis).", adrs: "Reddish-brown urine, hypotension, local injection site reactions.", contraindications: "Severe renal disease.", pharmaApplications: { dosageForms: "Injection (SC, IM).", formulations: "Desferal.", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "Colorimetric.", quantitative: "HPLC.", pharmacopoeial: "USP." }, specialNotes: "" },
          { name: "Penicillamine", classification: "Chelating Agent, DMARD", moa: "Chelates copper, mercury, zinc, and lead. Also has immunosuppressive effects.", therapeuticUses: "Wilson's disease (copper overload), rheumatoid arthritis.", adrs: "Rash, fever, bone marrow suppression.", contraindications: "Penicillin allergy (relative), pregnancy.", pharmaApplications: { dosageForms: "Capsules, tablets.", formulations: "Cuprimine.", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "TLC.", quantitative: "HPLC.", pharmacopoeial: "USP." }, specialNotes: "" },
          { name: "Dimercaprol (BAL)", classification: "Chelating Agent", moa: "Forms complexes with heavy metals like arsenic, gold, and mercury.", therapeuticUses: "Arsenic, gold, and mercury poisoning.", adrs: "Hypertension, tachycardia, nausea, vomiting, nephrotoxicity.", contraindications: "Iron poisoning.", pharmaApplications: { dosageForms: "Injection (IM in oil).", formulations: "BAL in Oil.", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "N/A", quantitative: "N/A", pharmacopoeial: "USP." }, specialNotes: "Administered by deep intramuscular injection, which can be painful." },
        ]
      },
      {
        name: "Antidotes",
        pharmaFocus: "Stocked in emergency kits in hospitals & pharmacies.",
        drugs: [
          { name: "Naloxone", classification: "Opioid Antagonist", moa: "A competitive antagonist at opioid receptors, displacing opioids and rapidly reversing their effects.", therapeuticUses: "Opioid overdose.", adrs: "Precipitation of acute opioid withdrawal.", contraindications: "Hypersensitivity.", pharmaApplications: { dosageForms: "Injection (IV, IM, SC), nasal spray.", formulations: "Narcan (nasal spray).", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "HPLC.", quantitative: "HPLC.", pharmacopoeial: "USP, BP." }, specialNotes: "Short half-life may require repeat dosing." },
          { name: "Atropine", classification: "Anticholinergic", moa: "Blocks acetylcholine at muscarinic receptors, counteracting the effects of excess acetylcholine from organophosphate poisoning.", therapeuticUses: "Antidote for organophosphate and carbamate insecticide poisoning, symptomatic bradycardia.", adrs: "Tachycardia, dry mouth, blurred vision.", contraindications: "Narrow-angle glaucoma.", pharmaApplications: { dosageForms: "Injection.", formulations: "AtroPen.", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "TLC.", quantitative: "Titration.", pharmacopoeial: "USP, BP." }, specialNotes: "Used in very large doses for poisoning." },
          { name: "Flumazenil", classification: "Benzodiazepine Antagonist", moa: "Competitively inhibits the activity at the benzodiazepine recognition site on the GABAA/benzodiazepine receptor complex.", therapeuticUses: "Reversal of benzodiazepine sedation/overdose.", adrs: "Can precipitate seizures in patients on BZDs for seizure control or in TCA overdose.", contraindications: "Patients with serious TCA overdose.", pharmaApplications: { dosageForms: "Injection (IV).", formulations: "Romazicon.", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "HPLC.", quantitative: "HPLC.", pharmacopoeial: "USP." }, specialNotes: "" },
          { name: "Activated Charcoal", classification: "Non-specific Adsorbent", moa: "Adsorbs a wide variety of drugs and toxins in the gastrointestinal tract, preventing their absorption.", therapeuticUses: "Acute oral poisoning.", adrs: "Vomiting, constipation, black stools.", contraindications: "Intestinal obstruction, unprotected airway.", pharmaApplications: { dosageForms: "Oral suspension, powder.", formulations: "Actidose-Aqua.", storage: "Store in a dry place." }, analyticalMethods: { qualitative: "N/A", quantitative: "N/A", pharmacopoeial: "USP." }, specialNotes: "Must be given within 1 hour of ingestion to be effective. Does not bind all toxins (e.g., iron, lithium, alcohol)." },
        ]
      },
      {
        name: "Diagnostic Agents",
        pharmaFocus: "Agents used for diagnosis, imaging, or functional testing.",
        drugs: [
          { name: "Iohexol", classification: "Iodinated Contrast Media", moa: "An iodinated compound that is radiopaque, allowing visualization of blood vessels and organs on X-ray or CT scans.", therapeuticUses: "Contrast agent for CT scans and angiography.", adrs: "Allergy/anaphylactoid reactions, contrast-induced nephropathy.", contraindications: "Severe hypersensitivity.", pharmaApplications: { dosageForms: "Injection.", formulations: "Omnipaque.", storage: "Protect from light." }, analyticalMethods: { qualitative: "HPLC.", quantitative: "HPLC.", pharmacopoeial: "USP." }, specialNotes: "Pharmacists monitor use in renal patients." },
          { name: "Barium Sulfate", classification: "Contrast Media", moa: "Coats the lining of the GI tract and is not absorbed, providing a clear outline on X-ray.", therapeuticUses: "Imaging of the gastrointestinal tract (barium swallow, enema).", adrs: "Constipation, abdominal cramps.", contraindications: "Bowel perforation or obstruction.", pharmaApplications: { dosageForms: "Oral suspension, powder for suspension.", formulations: "E-Z-EM.", storage: "Store at room temperature." }, analyticalMethods: { qualitative: "N/A", quantitative: "N/A", pharmacopoeial: "USP." }, specialNotes: "Patient should be well-hydrated to prevent impaction." },
          { name: "Technetium-99m", classification: "Radioisotope", moa: "A gamma-emitting radioisotope that can be attached to various pharmaceuticals to target specific organs for imaging.", therapeuticUses: "Nuclear medicine scans (bone, thyroid, cardiac).", adrs: "Minimal, due to small chemical quantities.", contraindications: "Pregnancy.", pharmaApplications: { dosageForms: "Generated on-site from a Molybdenum-99 generator.", formulations: "N/A.", storage: "Handled under specific radiopharmacy regulations." }, analyticalMethods: { qualitative: "Gamma spectroscopy.", quantitative: "Dose calibrator.", pharmacopoeial: "USP." }, specialNotes: "Short half-life of 6 hours." },
        ]
      },
      {
        name: "Therapeutic Gases",
        pharmaFocus: "Gases require special storage, pressure regulators, and pharmacopeial purity testing.",
        drugs: [
          { name: "Oxygen (O₂)", classification: "Medical Gas", moa: "Essential for aerobic metabolism and cellular respiration.", therapeuticUses: "Treatment of hypoxemia, respiratory failure, anesthesia.", adrs: "Oxygen toxicity with high concentrations over prolonged periods.", contraindications: "Certain conditions like paraquat poisoning.", pharmaApplications: { dosageForms: "Compressed gas in cylinders, liquid oxygen.", formulations: "N/A.", storage: "Store in a well-ventilated area, away from combustible materials." }, analyticalMethods: { qualitative: "Paramagnetic analyzer.", quantitative: "Paramagnetic analyzer.", pharmacopoeial: "USP." }, specialNotes: "Prescribed as a drug." },
          { name: "Nitric Oxide (NO)", classification: "Medical Gas, Vasodilator", moa: "Relaxes vascular smooth muscle by binding to guanylate cyclase, leading to increased cGMP and vasodilation.", therapeuticUses: "Persistent pulmonary hypertension of the newborn (PPHN).", adrs: "Hypotension, methemoglobinemia.", contraindications: "Neonates dependent on right-to-left shunting.", pharmaApplications: { dosageForms: "Inhaled gas.", formulations: "INOmax.", storage: "In specialized gas cylinders." }, analyticalMethods: { qualitative: "Chemiluminescence.", quantitative: "Chemiluminescence.", pharmacopoeial: "USP." }, specialNotes: "" },
          { name: "Helium (He)", classification: "Medical Gas", moa: "A low-density gas that, when mixed with oxygen (Heliox), reduces the work of breathing by decreasing turbulent airflow in obstructed airways.", therapeuticUses: "Severe upper airway obstruction (asthma, COPD).", adrs: "Voice changes.", contraindications: "N/A.", pharmaApplications: { dosageForms: "Compressed gas mixture.", formulations: "Heliox.", storage: "Gas cylinders." }, analyticalMethods: { qualitative: "N/A", quantitative: "N/A", pharmacopoeial: "USP." }, specialNotes: "Does not treat underlying condition, just eases breathing." },
        ]
      }
    ]
  },
