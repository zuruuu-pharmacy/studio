        ...
        <div className="space-y-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>A timetable generated by AI. Mark tasks as complete to track your progress.</CardDescription>
                     <div className="space-y-2 pt-2">
                        <Progress value={progressPercentage} className="w-full" />
                        <p className="text-sm text-muted-foreground">{completedCount} of {totalTasks} tasks completed ({Math.round(progressPercentage)}%)</p>
                    </div>
                </CardHeader>
                <CardContent>
                    <Table>
