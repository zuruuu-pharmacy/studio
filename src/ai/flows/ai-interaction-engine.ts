...
const CheckDrugInteractionsOutputSchema = z.object({
  interactions: z.array(z.object({
    ...
    interactingDrugs: z.array(z.string()).describe('The drugs involved in the interaction.')
  })).describe('A list of drug interactions.'),
});
...
You will analyze the provided list of medications and lab results (if any) to identify potential drug interactions.
